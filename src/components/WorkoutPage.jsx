  ...
  return (
    <div>
      <div className={s.heroCard}>
        ...
        <div className={s.heroStatStrip}>
          {heroMetrics.map(function (metric) {
            return (
              <div key={metric.id} className={s.heroStatStripCell}>
                <div className={s.heroStatValue}>{heroValues[metric.id]}</div>
                <div className={s.heroStatLabel}>{metric.label}</div>
              </div>
            );
          })}
        </div>
