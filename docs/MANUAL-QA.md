...
- [ ] One Muscle Mass & Fat Mass overlay card just above Visceral Fat Level when skeletal muscle mass or fat mass exists; a Muscle & Fat / Muscle - Fat / Muscle : Fat Ratio pill switches the overlay, SMM−FM delta, and SMM/FM ratio charts; both overlay series share one chart and Y-axis; Muscle - Fat draws a horizontal line at y=0; hidden when overlay, delta, and ratio are empty
